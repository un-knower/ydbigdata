...
public class YdbiBusinessTargetQuarter implements Serializable {
    private static final long serialVersionUID = 1L;

    private String data_date;            		// 日期  
    private String t_data_date;            		// 返回日期 
    private String org_id;            			// 日期
	private String org_name;           	 		// 机构名称    
	private String quarter_time;           	 		// 机构名称    
	...
	public String getQuarter_time() {
		return quarter_time;
	}
	public void setQuarter_time(String quarter_time) {
