 ...
 * </p>
 * <p>
 * Class: ydbi_business_target_month
 * 周趋势图
 * </p>
 *
 ...
 */
@RestController
@RequestMapping(value = "/action/ydbi_business_target_month")
public class Ydbi_business_target_monthController {

	private Logger logger = Logger.getLogger(Ydbi_business_target_monthController.class);

	@Autowired
	Ydbi_business_target_monthService ydbi_business_target_monthService;
	...
	public CustomResponseMsg searchData(CustomReqParameter parameter) {
		...
		List<YdbiBusinessTargetMonth> cvpBoardList = new ArrayList<YdbiBusinessTargetMonth>();
		...
		cvpBoardList = (List<YdbiBusinessTargetMonth>) ydbi_business_target_monthService.searchData(paramsMap);
