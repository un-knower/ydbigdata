...
public interface YS_loadRateMapper {
		//装载率head
		public List<com.yd.ydbi.ys.model.LR_2> findlrhead(Map<String, String> paramsMap);
		//装载率body正班车
		public List<com.yd.ydbi.ys.model.LR_2> findlrbodyzb(Map<String, String> paramsMap);
		//装载率body卡班车
		public List<com.yd.ydbi.ys.model.LR_2> findlrbodykb(Map<String, String> paramsMap);
		
		//计算各分拨中心发车详情
		public List<LR_Detail> finddetail(Map<String, String> paramsMap);
