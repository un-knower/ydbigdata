...
@RestController
@RequestMapping(value = "/action/carlaterate")
public class CarLateRateController {
	private Logger log = Logger.getLogger(CarLateRateController.class);
	@Autowired
	YS_carLateRate ys_lr;
