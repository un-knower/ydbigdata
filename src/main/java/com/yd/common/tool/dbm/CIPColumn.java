...
public class CIPColumn {
	...
	public void generateUIInfo(){
		...
		//f、日期信息
		else if(javaProperty.endsWith("date")||jdbcTypeName.equals("DATE")){
			ui_control = "input";
			ui_control_type = "text";
			ui_class = "easyui-datebox";
			propertyType=4;
		...
		//g、时间戳信息
		else if(javaProperty.endsWith("time")||jdbcTypeName.equals("TIMESTAMP")){
			ui_control = "input";
			ui_control_type = "text";
			ui_class = "easyui-datetimebox";
			propertyType=5;
