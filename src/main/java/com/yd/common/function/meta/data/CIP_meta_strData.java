...
/**
 * <p>Data实体类</p>
 * <p>View: cip_meta_str - 系统数据结构表</p>
 * 用于检索数据，建立在视图基础上
 * @since 2015-10-08 09:03:37
 */
public class CIP_meta_strData {
	...
	*/
	...
	public String getStr_module_name() {
		return str_module_name;
	}

	public void setStr_module_name(String str_module_name) {
		this.str_module_name = str_module_name;
	}
	...
	public String toString() {
		return "CIP_meta_strData [str_id=" + str_id + ", str_name=" + str_name
				+ ", str_memo=" + str_memo + ", str_type=" + str_type
				+ ", str_prefix=" + str_prefix + ", str_module=" + str_module
				+ ", func_set_id=" + func_set_id + ", ref_str_id=" + ref_str_id
				+ ", str_data_type=" + str_data_type + ", prd_date=" + prd_date
				+ ", form_template=" + form_template + ", list_template="
				+ list_template + ", src_sys_id=" + src_sys_id + ", resp_id="
				+ resp_id + ", resp_org=" + resp_org + ", update_time="
				+ update_time + ", create_time=" + create_time + ", operator="
				+ operator + ", str_type_name=" + str_type_name
				+ ", str_data_type_name=" + str_data_type_name
				+ ", str_module_name=" + str_module_name + ", op_flag="
				+ "]";
	}
