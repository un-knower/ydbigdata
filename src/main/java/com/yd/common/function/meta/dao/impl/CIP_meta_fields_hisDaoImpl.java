...
@Repository
public class CIP_meta_fields_hisDaoImpl extends IDaoImpl<CIP_meta_fields_hisPO> 
						implements CIP_meta_fields_hisDao {
	
	private final BeanPropertyRowMapper<CIP_meta_fields_hisData> dataRM = BeanPropertyRowMapper.newInstance(CIP_meta_fields_hisData.class);
	
	public CIP_meta_fields_hisDaoImpl() {
		super();
		this.tableName = "cip_meta_fields_his";
	...
	private CIP_meta_fields_hisMapper mapperRM = new CIP_meta_fields_hisMapper();
