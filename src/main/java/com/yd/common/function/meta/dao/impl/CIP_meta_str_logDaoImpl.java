...
@Repository
public class CIP_meta_str_logDaoImpl extends IDaoImpl<CIP_meta_str_logPO> 
						implements CIP_meta_str_logDao {
	
	private final BeanPropertyRowMapper<CIP_meta_str_logData> dataRM = BeanPropertyRowMapper.newInstance(CIP_meta_str_logData.class);
	
	public CIP_meta_str_logDaoImpl() {
		super();
		this.tableName = "cip_meta_str_log";
	...
	public void deleteByStrId(String str_id){
		String sql = "delete from cip_meta_str_log where str_id = '" + str_id + "'";
		try{
	...
	private CIP_meta_str_logMapper mapperRM = new CIP_meta_str_logMapper();
