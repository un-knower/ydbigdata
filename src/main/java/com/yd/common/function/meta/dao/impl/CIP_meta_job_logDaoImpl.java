...
@Repository
public class CIP_meta_job_logDaoImpl extends IDaoImpl<CIP_meta_job_logPO> 
						implements CIP_meta_job_logDao {
	
	private final BeanPropertyRowMapper<CIP_meta_job_logData> dataRM = BeanPropertyRowMapper.newInstance(CIP_meta_job_logData.class);
	
	public CIP_meta_job_logDaoImpl() {
		super();
		this.tableName = "cip_meta_job_log";
	...
	private CIP_meta_job_logMapper mapperRM = new CIP_meta_job_logMapper();
