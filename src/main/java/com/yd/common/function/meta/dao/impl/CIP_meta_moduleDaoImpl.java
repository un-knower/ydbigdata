...
@Repository
public class CIP_meta_moduleDaoImpl extends IDaoImpl<CIP_meta_modulePO> 
						implements CIP_meta_moduleDao {
	
	private final BeanPropertyRowMapper<CIP_meta_moduleData> dataRM = BeanPropertyRowMapper.newInstance(CIP_meta_moduleData.class);
	
	public CIP_meta_moduleDaoImpl() {
		super();
		this.tableName = "cip_meta_module";
	...
	private CIP_meta_moduleMapper mapperRM = new CIP_meta_moduleMapper();
