...
@Service
public class CIP_admin_access_resServiceImpl implements CIP_admin_access_resService {
	
	@Autowired
	private CIP_admin_access_resDao dataDao = null;
	@Autowired
	 ...
	 */
	@Override
	public void updateData(CIP_admin_access_resVO vo, CIPRuntimeOperator operateInf){
		//TODO
		CIP_admin_access_resPO po = vo.toPO();
		Object[] keys = po.getKeys();
		CIP_admin_access_resPO po0 = dataDao.getSingle(keys);
		if( po0 == null ){
	 ...
	 */
	@Override
	public void addData(CIP_admin_access_resVO vo, CIPRuntimeOperator operateInf){
		CIP_admin_access_resPO po = vo.toPO();
		Object[] keys = po.getKeys();
		CIP_admin_access_resPO po0 = dataDao.getSingle(keys);
		if( po0!= null ){
	...
	public CIP_admin_access_resVO getData(Object[] keys ){
		CIP_admin_access_resPO  po = dataDao.getSingle(keys);
		if(po == null)
			throw new CIPServiceException(CIPErrorCode.ERROR_RECORD_NOT_EXISTS);
	...
	public List<CIP_admin_access_resData> searchData(CIPPageInfo page, CIPReqCondition[] conditions){
		...
		List<CIP_admin_access_resData> datas = dataDao.searchData(page, conditions);
		return datas;
	}
	...
	public List<Map<String, Object>> exportEntities(CIPPageInfo page,CIPReqCondition[] conditions,
		...
		if(xFirst){
			...
			log.setOp_table_id("cip_admin_access_res");
			log.setOp_obj_id("");
			log.setOp_type("E");
