...
@Repository
public class CIP_admin_log_mdmDaoImpl extends IDaoImpl<CIP_admin_log_mdmPO> 
						implements CIP_admin_log_mdmDao {
	
	private final BeanPropertyRowMapper<CIP_admin_log_mdmData> dataRM = BeanPropertyRowMapper.newInstance(CIP_admin_log_mdmData.class);
	
	public CIP_admin_log_mdmDaoImpl() {
		super();
		this.tableName = "cip_admin_log_mdm";
	...
	private CIP_admin_log_mdmMapper mapperRM = new CIP_admin_log_mdmMapper();
