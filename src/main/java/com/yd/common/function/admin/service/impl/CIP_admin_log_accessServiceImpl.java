...
@Service(value="cipAccessLogService")
public class CIP_admin_log_accessServiceImpl implements CIP_admin_log_accessService {
	
	@Autowired
	private CIP_admin_log_accessDao dataDao = null;
	@Autowired
	 ...
	 */
	@Override
	public void updateData(CIP_admin_log_accessVO vo, CIPRuntimeOperator operateInf){
		//TODO
		CIP_admin_log_accessPO po = vo.toPO();
		Object[] keys = po.getKeys();
		CIP_admin_log_accessPO po0 = dataDao.getSingle(keys);
		if( po0 == null ){
	 ...
	 */
	@Override
	public void addData(CIP_admin_log_accessVO vo, CIPRuntimeOperator operateInf){
		CIP_admin_log_accessPO po = vo.toPO();
		Object[] keys = po.getKeys();
		CIP_admin_log_accessPO po0 = dataDao.getSingle(keys);
		if( po0!= null ){
	...
	public CIP_admin_log_accessVO getData(Object[] keys ){
		CIP_admin_log_accessPO  po = dataDao.getSingle(keys);
		if(po == null)
			throw new CIPServiceException(CIPErrorCode.ERROR_RECORD_NOT_EXISTS);
	...
	public List<CIP_admin_log_accessData> searchData(CIPPageInfo page, CIPReqCondition[] conditions){
		...
		List<CIP_admin_log_accessData> datas = dataDao.searchData(page, conditions);
		return datas;
	}
	...
	public List<Map<String, Object>> exportEntities(CIPPageInfo page,CIPReqCondition[] conditions,
		...
		if(xFirst){
			...
			log.setOp_table_id("cip_admin_log_access");
			log.setOp_obj_id("");
			log.setOp_type("E");
