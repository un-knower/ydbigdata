...
@Repository
public class CIP_admin_access_ctrlDaoImpl extends IDaoImpl<CIP_admin_access_ctrlPO> 
						implements CIP_admin_access_ctrlDao {
	
	private final BeanPropertyRowMapper<CIP_admin_access_ctrlData> dataRM = BeanPropertyRowMapper.newInstance(CIP_admin_access_ctrlData.class);
	
	public CIP_admin_access_ctrlDaoImpl() {
		super();
		this.tableName = "cip_admin_access_ctrl";
	...
	private CIP_admin_access_ctrlMapper mapperRM = new CIP_admin_access_ctrlMapper();
