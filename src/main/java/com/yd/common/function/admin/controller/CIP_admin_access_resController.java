...
import com.yd.common.function.admin.service.CIP_admin_access_resService;
...
/**
 * <p>控制层实现类</p>
 * <p>Class: CIP_admin_access_resController</p>
 *
 * @since 2015-08-20 09:11:16
 */
@RestController
@RequestMapping(value = "/actions/admin_access_res")
public class CIP_admin_access_resController {
	
	@Autowired
	private CIP_admin_access_resService dataService  = null;
	
	private static final String C_ACTION_ADD_DATA = "CIP_admin_access_res_addData";
	/**
	* 新增系统访问资源配置
	*/
	@RequestMapping(value="/addData")
	public CIPResponseMsg addData(@RequestBody CIP_admin_access_resVO vo) {
	...
	private static final String C_ACTION_GET_DATA = "CIP_admin_access_res_getData";
	/**
	* 查看系统访问资源配置
	*/
	@RequestMapping(value = "/getData")
	public CIPResponseMsg getData(@RequestBody CIP_admin_access_resVO vo) {
		CIPResponseMsg msg = new CIPResponseMsg();
		try {
			Object[] keys = vo.getKeys();
			CIP_admin_access_resVO vo0 = dataService.getData(keys);
			msg.errorCode = CIPErrorCode.CALL_SUCCESS.code;
			msg.msg = CIPErrorCode.CALL_SUCCESS.name;
			msg.data = vo0;
		} catch (CIPServiceException e) {
	...
	private static final String C_ACTION_DELETE_DATA = "CIP_admin_access_res_deleteData";
	/**
	* 删除系统访问资源配置
	*/
	@RequestMapping(value = "/deleteData")
	public CIPResponseMsg deleteData(@RequestBody CIP_admin_access_resVO vo) {
		CIPResponseMsg msg = new CIPResponseMsg();
		try {
			Object[] keys = vo.getKeys();
	...
	private static final String C_ACTION_UPDATE_DATA = "CIP_admin_access_res_updateData";
	/**
	* 更新系统访问资源配置
	*/
	@RequestMapping(value = "/updateData")
	public CIPResponseMsg updateData(@RequestBody CIP_admin_access_resVO vo) {
		CIPResponseMsg msg = new CIPResponseMsg();
		try {
	...
	private static final String C_ACTION_SEARCH_DATA = "CIP_admin_access_res_searchData";
	...
	*/
	...
	public CIPResponseQueryMsg searchData(CIPReqParameter parameter) {
		...
		try {
			...
			List<CIP_admin_access_resData> vos = dataService.searchData(page,conditions);
	...
	private static final String C_ACTION_EXPORT_EXCEL = "CIP_admin_access_res_exportEntities";
	...
	public void exportEntities(CIPReqParameter parameter, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			SXSSFWorkbook wb = ExcelSheetParser.createWorkBook(sheetName,
					CIP_admin_access_resMapper.getExcelTitle(), entities);
			...
			if (total > rows) {
				...
				for (int i = 2; i <= count; i++) {
					...
					ExcelSheetParser.appendWorkBook(wb, sheetName, CIP_admin_access_resMapper.getExcelTitle(), entities);
				}
			}
