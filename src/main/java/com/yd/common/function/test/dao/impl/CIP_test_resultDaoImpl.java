...
@Repository
public class CIP_test_resultDaoImpl extends IDaoImpl<CIP_test_resultPO> 
						implements CIP_test_resultDao {
	
	private final BeanPropertyRowMapper<CIP_test_resultData> dataRM = BeanPropertyRowMapper.newInstance(CIP_test_resultData.class);
	
	public CIP_test_resultDaoImpl() {
		super();
		this.tableName = "cip_test_result";
	...
	private CIP_test_resultMapper mapperRM = new CIP_test_resultMapper();
