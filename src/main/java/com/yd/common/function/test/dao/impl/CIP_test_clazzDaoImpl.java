...
@Repository
public class CIP_test_clazzDaoImpl extends IDaoImpl<CIP_test_clazzPO> 
						implements CIP_test_clazzDao {
	
	private final BeanPropertyRowMapper<CIP_test_clazzData> dataRM = BeanPropertyRowMapper.newInstance(CIP_test_clazzData.class);
	
	public CIP_test_clazzDaoImpl() {
		super();
		this.tableName = "cip_test_clazz";
	...
	private CIP_test_clazzMapper mapperRM = new CIP_test_clazzMapper();
