...
@Repository
public class CIP_test_caseDaoImpl extends IDaoImpl<CIP_test_casePO> 
						implements CIP_test_caseDao {
	
	private final BeanPropertyRowMapper<CIP_test_caseData> dataRM = BeanPropertyRowMapper.newInstance(CIP_test_caseData.class);
	
	public CIP_test_caseDaoImpl() {
		super();
		this.tableName = "cip_test_case";
	...
	private CIP_test_caseMapper mapperRM = new CIP_test_caseMapper();
