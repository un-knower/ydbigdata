...
@Service
public interface CIP_test_resultService {

	public void updateData(CIP_test_resultVO d, CIPRuntimeOperator operateInf);
	
	public void addData(CIP_test_resultVO d, CIPRuntimeOperator operateInf);
