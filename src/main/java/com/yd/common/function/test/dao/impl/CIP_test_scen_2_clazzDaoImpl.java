...
@Repository
public class CIP_test_scen_2_clazzDaoImpl extends IDaoImpl<CIP_test_scen_2_clazzPO> 
						implements CIP_test_scen_2_clazzDao {
	
	private final BeanPropertyRowMapper<CIP_test_scen_2_clazzData> dataRM = BeanPropertyRowMapper.newInstance(CIP_test_scen_2_clazzData.class);
	
	public CIP_test_scen_2_clazzDaoImpl() {
		super();
		this.tableName = "cip_test_scen_2_clazz";
	...
	private CIP_test_scen_2_clazzMapper mapperRM = new CIP_test_scen_2_clazzMapper();
